...
<head>
    ...
    <link href="{{ asset('/material-lite/plugins/chartist-plugin-tooltip-master/dist/chartist-plugin-tooltip.css') }}"
          rel="stylesheet">
    ...
    <header class="topbar">
        <nav class="navbar top-navbar navbar-toggleable-sm navbar-light">
            ...
            <div class="navbar-collapse">
                ...
                <!-- ============================================================== -->
                <ul class="navbar-nav mr-auto mt-md-0" style="margin-left: 10px;">
                    <!-- This is  -->
    ...
    <aside class="left-sidebar">
        ...
        <div class="scroll-sidebar">
            ...
            <nav class="sidebar-nav">
                <ul id="sidebarnav">
                    <li><a class="waves-effect waves-dark" href="{{ route('timetable') }}" aria-expanded="false"><i
                                    class="mdi mdi-gauge"></i><span class="hide-menu">Timetable</span></a>
                    </li>
                    <li><a class="waves-effect waves-dark" href="{{ route('students_attendance') }}"
                           aria-expanded="false"><i class="mdi mdi-account-check"></i><span class="hide-menu">Students' Attendance</span></a>
                    </li>
                    @if(sizeof(App\Klass::getAssociatedClass(App\Teacher::getCurrentTeacher()->teacher_id)) > 0)
                        <li><a class="waves-effect waves-dark" href="{{ route('teacher.attendance_details') }}"
                               aria-expanded="false"><i class="mdi mdi-account-check"></i><span class="hide-menu">Attendance Details</span></a>
                        </li>
