...
@section('content')
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-md-4 col-lg-4 col-sm-4 col-xs-4" style="padding: 10px;padding-bottom: 0px;">
                <button type="button" class="btn btn-success pull-right" data-toggle="modal" id="add-btn"
                        data-target="#addOrEditClass"> Add a Class
                </button>
            </div>
        </div>
    </div>
                ...
                <table class="table">
                    ...
                    @foreach($klasses as $klass)
                        <tr>
                            ...
                            <td>{{ $klass->name }}</td>
                            <td>
                                <button type="button" class="btn btn-primary" data-cid="{{ $klass->class_id }}"
                                        data-yid="{{ $klass->year->year_id }}" data-name="{{ $klass->name }}"
                                        data-sform="{{ $klass->short_form }}" data-toggle="modal" id="edit-btn"
                                        data-target="#addOrEditClass">Edit
                                </button>
                            </td>
                        </tr>
                    @endforeach
                    ...
                    <div class="modal-body">
                        <div class="container">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-12">
                                    <select class="form-control input-year-id" name="year_id" style="margin-top: 7px;"
                                            required>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-12">
                                    <input class="form-control form-control-line input-class-name" name="name"
                                           type="text" required>
                                </div>
                            </div>
                            <div class="form-group">
                                ...
                                <div class="col-md-12">
                                    <input class="form-control form-control-line input-class-short-form"
                                           name="short_form" type="text" required>
                                </div>
                            </div>
                        </div>
                    </div>
