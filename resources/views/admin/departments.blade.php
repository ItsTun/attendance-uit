        ...
        <div class="row">
            ...
            <div class="col-lg-4 col-md-4 col-sm-4 col-xs-4" style="padding: 10px;padding-bottom: 0px;">
                <button type="button" class="btn btn-success pull-right" data-toggle="modal" id="add-btn"
                        data-target="#addOrEditDepartment">
                    Add New Department
                </button>
            </div>
        </div>
                            ...
                            <td>
                                @foreach($faculty->faculty_class as $faculty_class)
                                    <span class="label label-primary"
                                          title="{{ $faculty_class->klass->name }}">{{ $faculty_class->klass->short_form }}</span>
                                @endforeach
                            </td>
                            <td>
                                <button type="button" class="btn btn-primary edit-btn"
                                        ...
                                        data-faculty-class="{{ $faculty->faculty_class }}" id="edit-btn"
                                        data-toggle="modal" data-target="#addOrEditDepartment">Edit
                                </button>
                            </td>
                        </tr>
                    @endforeach
                    ...
                    <div class="modal-body">
                        <div class="container">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-12">
                                    <input class="form-control form-control-line input-faculty-name" type="text"
                                           name="name" required>
                                </div>
                            </div>
                            <div class="form-group">
