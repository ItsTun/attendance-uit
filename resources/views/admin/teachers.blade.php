    ...
    <form action="#" method="get">
        <div class="card" style="margin: 7px;">
            <div class="card-block">
                ...
                {{ $teachers->links('pagination.circle-pagination') }}
                                ...
                                <div class="modal-body">
                                    <div class="container">
                                        <div class="form-group">
                                            <label class="col-md-12">Name</label>
                                            <div class="col-md-12">
                                                <input class="form-control form-control-line input-teacher-name"
                                                       type="text"
                                                       name="name" required/>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-12">
                                                <input class="form-control form-control-line input-teacher-email"
                                                       type="email"
                                                       name="email" required/>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label class="col-md-12" style="margin-bottom: 10px;">Departments</label>
                                            <div class="col-md-12">
                                                        ...
                                                        @foreach($year->klasses as $klass)
                                                            <optgroup label="{{ $year->name }} - {{ $klass->name }}">
                                                                @foreach($klass->subject_class as $subject_class)
                                                                    @if($subject_class->subject['subject_code'] != '000' && !is_null($subject_class->subject['subject_id']))
                                        ...
                                        <div class="col-md-12" style="margin-top: 10px; margin-bottom: 15px;">
                                            <select class="year-head-of" name="year_head_of"
                                                    style="width: 100%;display: none;">
                                                <option style="display:none"></option>
                                                @foreach($years as $year)
                                        ...
                                        <input type="checkbox" id="is-principle" name="is_principle"
                                               value="is-principle"/>
