...
@section('content')
    ...
    @if(!is_null($class_id) && !is_null($year_id))
        <div id="redips-drag">
            ...
            <center>
                <div id="left" style="padding-top:15px; margin-bottom: 15px;">
                            ...
                            @foreach($subject_classes as $key => $subject_class)
                                @if(!is_null($subject_class->subject_id))
                                    <td class="dark" align="center">
                                        <div data-subject-class-id="{{ $subject_class->subject_class_id }}"
                                             class="redips-drag redips-mark redips-clone ar">{{ $subject_class->subject['subject_code'] }}
                                            <br><input type="text" placeholder="Room" class="room" required/></div>
                                    </td>
                                    @if($key != 0 && $key % 4 == 0)
                        </tr>
                        <tr>
                    ...
                    <div id="right" style="overflow:auto; position: relative">
                        <table id="table2">
                            ...
                            <tr class="lunch-break-row">
                                ...
                                <td class="redips-mark small-cell lunch-time"><input type="radio" name="is_lunch_time"
                                                                                     id="lt1" value="1"
                                                                                     onclick="onRadioSelect(this)"/><label
                                            for="lt1"></label></td>
                                <td class="redips-mark small-cell lunch-time"><input type="radio" name="is_lunch_time"
                                                                                     id="lt2" value="2"
                                                                                     onclick="onRadioSelect(this)"/><label
                                ...
                                <td class="redips-mark small-cell lunch-time"><input type="radio" name="is_lunch_time"
                                                                                     ...
                                                                                     onclick="onRadioSelect(this)"/><label
                                            for="lt3"></label></td>
                                <td class="redips-mark small-cell lunch-time"><input type="radio" checked="checked"
                                                                                     name="is_lunch_time" id="lt4"
                                                                                     value="4"
                                                                                     onclick="onRadioSelect(this)"/><label
                                            for="lt4"></label></td>
                                <td class="redips-mark small-cell lunch-time"><input type="radio" name="is_lunch_time"
                                ...
                                <td class="redips-mark">
                                    <div class="btn btn-warning" onclick="removeOneColumn()">Remove Period</div>
                                    <br>
                                </td>
                            </tr>
                            <tr class="time-chooser-row">
                                ...
                                <td class="medium-cell tc1 redips-mark dark">
                                    <input type="text" class="time-chooser t1" onchange="ontimechange(this)" required/>
                                    <br>:<br> <input type="text" class="time-chooser t2" onchange="ontimechange(this)"
                                                     required/>
                                </td>
                                <td class="medium-cell tc2 redips-mark dark">
                                    <input type="text" class="time-chooser t3" onchange="ontimechange(this)" required/>
                                    <br>:<br> <input type="text" class="time-chooser t4" onchange="ontimechange(this)"
                                                     required/>
                                </td>
                                <td class="medium-cell tc3 redips-mark dark">
                                    <input type="text" class="time-chooser t5" onchange="ontimechange(this)" required/>
                                    <br>:<br> <input type="text" class="time-chooser t6" onchange="ontimechange(this)"
                                                     required/>
                                </td>
                                <td class="medium-cell tc4 redips-mark dark">
                                    <input type="text" class="time-chooser t7" onchange="ontimechange(this)" required/>
                                    <br>:<br> <input type="text" class="time-chooser t8" onchange="ontimechange(this)"
                                                     required/>
                                </td>
                                <td class="medium-cell tc5 redips-mark dark">
                                    <input type="text" class="time-chooser t9" onchange="ontimechange(this)" required/>
                                    <br>:<br> <input type="text" class="time-chooser t10" onchange="ontimechange(this)"
                                                     required/>
                                </td>
                                <td class="medium-cell tc6 redips-mark dark">
                                    <input type="text" class="time-chooser t11" onchange="ontimechange(this)" required/>
                                    <br>:<br> <input type="text" class="time-chooser t12" onchange="ontimechange(this)"
                                                     required/>
                                </td>
                                <td class="medium-cell tc7 redips-mark dark">
                                    <input type="text" class="time-chooser t13" onchange="ontimechange(this)" required/>
                                    <br>:<br> <input type="text" class="time-chooser t14" onchange="ontimechange(this)"
                                                     required/>
                                </td>
                                <td class="redips-mark">
                                    <div class="btn btn-info" onclick="addOneColumn()" style="margin-top: 5px;">Add
                                        Period
                                    </div>
                                    <br>
                                    <input type="submit" class="btn btn-success"
                                           style="margin-top: 5px;background: #26c6da !important" value="Save"/>
                                </td>
                            </tr>
                            <tr class="row1">
        ...
        function placePeriods() {
            for (var i = 0; i < periods.length; i++) {
                ...
                if (period.subject_class_id != lunchBreak.subject_class_id) {
                    if (period.subject_class_id != undefined) $('.r' + period.day + '.c' + period.period_num).html('<div data-subject-class-id="' + period.subject_class_id + '" class="redips-drag ar" style="border-style: solid; cursor: move;" id="c' + i + '">' + getSubjectCode(period.subject_class_id) + '<br><input type="text" placeholder="Room" class="room" value="' + period.room + '"required></div>');
                } else {
